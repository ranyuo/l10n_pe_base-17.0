...
class ResCompany(models.Model):
    ...
    default_claim_attention_period = fields.Integer(string="Plazo de atención de reclamo")
...
class ResConfigSettings(models.TransientModel):
    ...
    claim_attention_period = fields.Integer(related="company_id.default_claim_attention_period", readonly=False, default = 15)
